...
module.exports = class Experiment {
    ...
    constructor(xml) {
        ...
        this.accession = this.object.EXPERIMENT_SET.EXPERIMENT.accession;
        this.studyAccession = this.object.EXPERIMENT_SET.EXPERIMENT.STUDY_REF.accession;
        this.sampleAccesion = this.object.EXPERIMENT_SET.EXPERIMENT.DESIGN.SAMPLE_DESCRIPTOR.accession;
    }
    ...
    static GetAllExperiments() {
        return new Promise((good, bad) => {
            this.ListAllExperiments()
                .then(experimentIDS => {
                    Promise.all(experimentIDS.map(eid => {
     ...
     */
    getStudy() {
        return Study.GetStudy(this.studyAccession)
    }
     ...
     */
    getSample() {
        return Sample.GetSample(this.sampleAccesion);
    }
};